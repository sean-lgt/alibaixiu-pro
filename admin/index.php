...
/*
 * @Author: your name
 * @Date: 2019-12-27 15:59:36
 * @LastEditTime : 2020-01-09 19:02:20
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \pro\jingcaishenghuo\admin\index.php
 */
...
// 获取界面所需要的数据
// 重复的操作一定封装起来
$posts_count = sean_fetch_one('select count(1) as num from posts;')['num'];

$categories_count = sean_fetch_one('select count(1) as num from categories;')['num'];

$comments_count = sean_fetch_one('select count(1) as num from comments;')['num'];
...
<body>
    ...
    <div class="main">
        ...
        <div class="container-fluid">
            <div class="jumbotron text-center">
                ...
                <p><a class="btn btn-primary btn-lg" href="/pro/jingcaishenghuo/admin/post-add.php" role="button">写文章</a></p>
            </div>
            <div class="row">
                <div class="col-md-4">
    ...
    <script src="/pro/jingcaishenghuo/static/assets/vendors/chart/Chart.js"></script>
    <script>
